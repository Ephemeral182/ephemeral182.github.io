 ...
 <tr>
  ...
  <tr>
      ...
      <td width="75%" valign="center" class="text-wrapper"> 
        ...
        <br>
        <a href="http://export.arxiv.org/abs/2305.09533#:~:text=propose%20an%20end-to-end%20transformer-based%20framework%20for%20nighttime%20haze,we%20introduce%20two%20powerful%20priors%20into%20the%20transformer">[a]</a>
        <a href="Ephemeral182.github.io">[Code]</a>
      </td>
      </tr>
