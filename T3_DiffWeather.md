...
<div class="fade-in">
  ...
  <div style="display: flex; justify-content: center; align-items: center; margin-bottom: 20px;">
    <div style="position: relative; width: 75%; max-width: 600px; height: 220px; overflow: hidden;"> <!-- 调整左边图的宽度 -->
    ...
    <div style="position: relative; width: 25%; max-width: 200px; height: 220px; overflow: hidden;"> <!-- 调整右边图的宽度 -->
