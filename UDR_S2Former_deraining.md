                ...
                <div class="col-md-8 col-md-offset-2 text-center">
                    <ul class="nav nav-pills nav-justified" style="box-shadow:0 0">
                        <li>
                            ...
                            <img class="post-logo" style="max-width:10%" src="https://ephemeral182.github.io/images/paper.jpg" >
                        ...
                        <li>
                            ...
                            <img class="post-logo" style="max-width:10%" src="https://ephemeral182.github.io/images/datatset.jpg" >
                                <h5><strong>Dataset</strong></h5>
                            </a>
                        </li>                        
                        <li>
                            <a href="https://github.com/haoyuc/VideoDesnowing">
                            <img class="post-logo" style="max-width:10%" src="https://ephemeral182.github.io/images/github.png" >
                                <h5><strong>Code</strong></h5>
                            </a>
                        </li>
                        <li>
                             <a href="">
                            <img class="post-logo" style="max-width:10%" src="https://ephemeral182.github.io/images/supplementary.jpg" >
